...
export default async function Hero() {
  ...
  return (
    <>
      <section className="text-white bg-cover bg-no-repeat bg-bottom relative overflow-hidden bg-primary-800">

  <div
    className="absolute top-0 left-0 w-full h-full bg-no-repeat bg-cover opacity-25"
    style={{
      backgroundImage:
        'url(/bg-banner.png)',
    }}
  ...
  <div className="max-w-7xl mx-auto px-4 md:px-2 flex flex-col md:flex-row gap-0 md:gap-10 items-center">
      ...
      <div className="flex flex-col items-center md:items-center">
        ...
        {data.content1 && (
          <MotionItem
            ...
            variant="fade"
            delay={0.2}
            className="w-full md:w-[550px] max-w-full"
          >

            <div className="mt-6 bg-primary-950/50 p-4 rounded-xl">
    ...
    <MotionItem
      ...
      variant="slideUp"
      delay={0.32}
      className="w-full md:w-[45%] absolute md:absolute bottom-2 md:bottom-4 right-0 md:right-[6vw] text-center z-20 px-4"
    >
